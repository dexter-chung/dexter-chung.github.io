...
layout: essay
type: essay
title: "Smartly Asking a Question"
...
For how to make a smart question, some of the things included are a precise summary of what is trying to be accomplished, the location and what the error is, the expected outcome from the program and the environment in which was made in. In the Stack Overflow forum here is a example of a  [smart question](https://stackoverflow.com/questions/79879093/version-mismatch-with-a-sub-dependency-bitgo-utxo-core). The asked includes many aspects of what makes a smart question such as the environment, expected outcome, and error message. Now here is a example of a [non-smart question](https://stackoverflow.com/questions/79873402/api-integration-in-shopify), this question does not clearly explain what they need help in. 
